            ...
            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <form action="" method="GET">
                            <input type="text" id="mySearchText" name="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Transaction" />
                        </form>
                ...
                <div class="d-flex justify-content-end" data-kt-subscription-table-toolbar="base">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                        <form action="{{ route('front.stores.transactions',$store->id) }}" method="GET" id="filterForm">
                            <!--begin::Header-->
                            <div class="px-7 py-5">
                            ...
                            <div class="px-7 py-5" data-kt-subscription-table-filter="form">
                                ...
                                <div class="mb-10">
                                    ...
                                    <select id="status" name="status" class="form-select form-select-solid fw-bold" data-kt-select2="true" data-control="select2" data-placeholder="Select an option">
                                        ...
                                        <option {{ ( !is_null(request('status')) && request('status') === (string) $key  ) ? 'selected' : '' }} value="{{ $key }}">{{ $value }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="mb-10">
                                    ...
                                    <select id="providers" name="providers" class="form-select form-select-solid fw-bold" data-kt-select2="true" data-control="select2" data-placeholder="Select an option">
                                        <option {{ !request()->has('providers') || request('providers') == 'all' ? 'selected' : '' }} value="all">All
                                        </option>
                                        @foreach ($providers as $provider)
                                        {{-- <option value="{{ $provider->id }}" {{ optional($provider)->value == $provider->id ? 'selected' : '' }}>{{ $provider->name }} </option> --}}
                                        <option {{ request('providers') == $provider->id ? 'selected' : '' }} value="{{ $provider->id }}">{{ $provider->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="fv-row mb-10">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input class="form-control form-control-solid" placeholder="Pick a date" name="date" id="dateRange" value="{{ $startDate && $endDate ? $startDate . ' to ' . $endDate : ($startDate ? $startDate : '') }}" />
                                    <!--end::Input-->
                                </div>
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="reset" class="btn btn-light btn-active-light-primary fw-semibold me-2 px-6" data-kt-menu-dismiss="true" onclick=" window.location.href = '{{ route('front.transactions') }}';" data-kt-subscription-table-filter="reset">Reset</button>
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_sales_table">
                ...
                <tbody class="fw-semibold text-gray-600">
                    ...
                    <tr>
                        ...
                        <!--begin::ID=-->
                        <td>
                            <a href="#" class="text-gray-800 text-hover-primary fw-bold">{{ $val->id }}</a>
                        </td>
                        <!--begin::ID=-->
                        <!--begin::Phone=-->
                        <td>
                            <a href="tel:{{ $val->from }}" class="text-gray-800 text-hover-primary fw-bold">{{ $val->from }}</a>
                        </td>
                        <!--end::Phone=-->
                        <!--begin::Status=-->
                        <td class="text-center pe-0" data-order="Pending">
                            <!--begin::Badges-->
                            <span class="badge py-3 px-4 fs-7 badge-light-{{ App\Models\front\transactions::STATUSES_CLASSES[$val->status] }}">{{ App\Models\front\transactions::STATUSES[$val->status] }}</span>
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                <form id="kt_subscriptions_export_form" class="form" action="{{ route('front.transactions.export',$store->id) }}" method="POST">
                    @csrf
                    <!--begin::Input group-->
                    <div class="fv-row mb-10">
                        <!--begin::Label-->
...
<div class="modal fade" id="kt_modal_add_user" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                <form id="kt_modal_add_user_form" class="form" enctype="multipart/form-data" action="{{ route('front.transactions.store') }}" method="POST">
@csrf
...
<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
    ...
    <div class="fv-row mb-7">
        ...
        <!--end::Label-->
        <!--begin::Input-->
        <textarea style="height: 117px;" type="text" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 msg_body" placeholder="message body" id="msg_body" name="msg_body"></textarea>
        <!--end::Input-->
    </div>
    <!--end::Input group-->
    ...
    <div class="mb-10">
        ...
        <select id="store" name="store" class="form-select form-select-solid fw-bold" data-kt-select2="true" data-control="select2" data-placeholder="Select an option">
            <option></option>
            @foreach ($stores as $store)
            <option value="{{ $store->id }}" {{ optional($store)->value == $store->id ? 'selected' : '' }}>
                {{ $store->name }} </option>
            @endforeach
        </select>
    </div>
    ...
    <div class="mb-10">
        <label class="form-label fs-6 fw-semibold">Providers:</label>
        <select id="provider" name="provider" class="form-select form-select-solid fw-bold" data-kt-select2="true" data-control="select2" data-placeholder="Select an option">

            <option></option>
            @foreach ($providers as $provider)
            <option value="{{ $provider->id }}" {{ optional($provider)->value == $provider->id ? 'selected' : '' }}>
