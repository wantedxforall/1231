<div id="kt_aside" class="aside" data-kt-drawer="true" data-kt-drawer-name="aside"
    sdata-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="auto"
            ...
            <div class="hover-scroll-overlay-y mb-5 px-5" data-kt-scroll="true"
                ...
                <ul class="nav flex-column w-100" id="kt_aside_nav_tabs">
                    ...
                    <li class="nav-item mb-2" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="right"
                        ...
                        {{-- @dump(request()) --}}
                        <!--begin::Nav link-->
                        <a class="nav-link btn btn-icon {{ request()->is('dashboard') ? 'btn-active-color-primary btn-color-gray-400 btn-active-light active' : '' }}"
                    ...
                    <!--begin::Nav item-->
                    <li class="nav-item mb-2" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="right"
                        data-bs-dismiss="click" title="Stores">
                        <!--begin::Nav link-->
                        <a class="nav-link btn btn-icon {{ request()->is('dashboard/stores') ? 'btn-active-color-primary btn-color-gray-400 btn-active-light active' : '' }}"
                    ...
                    <!--begin::Nav item-->
                    <li class="nav-item mb-2" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="right"
                        data-bs-dismiss="click" title="Invoices">
                        <!--begin::Nav link-->
                        <a class="nav-link btn btn-icon {{ request()->is('dashboard/invoices') ? 'btn-active-color-primary btn-color-gray-400 btn-active-light active' : '' }}"
                    ...
                    <li class="nav-item mb-2" data-bs-toggle="tooltip" data-bs-trigger="hover"
                        data-bs-placement="right" data-bs-dismiss="click" title="Pricing">
                        <!--begin::Nav link-->
                        <a class="nav-link btn btn-icon {{ request()->is('dashboard/plans') ? 'btn-active-color-primary btn-color-gray-400 btn-active-light active' : '' }}"
                    ...
                    <li class="nav-item mb-2" data-bs-toggle="tooltip" data-bs-trigger="hover"
                        ...
                        <!--begin::Nav link-->
                        <a class="nav-link btn btn-icon {{ request()->is('dashboard/users') ? 'btn-active-color-primary btn-color-gray-400 btn-active-light active' : '' }}"
                    ...
                    <li class="nav-item mb-2" data-bs-toggle="tooltip" data-bs-trigger="hover"
                        ...
                        <!--begin::Nav link-->
                        <a class="nav-link btn btn-icon {{ request()->is('dashboard/options') ? 'btn-active-color-primary btn-color-gray-400 btn-active-light active' : '' }}"
                            href="{{ route('admin.options.index') }}">
                            <!--begin::Svg Icon | path: /var/www/preview.keenthemes.com/kt-products/docs/metronic/html/releases/2023-01-26-051612/core/html/src/media/icons/duotune/coding/cod001.svg-->
...
<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar"
    ...
    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
        ...
        <a href="/">
            ...
            <img alt="Logo" src="{{ $options['dark_site_logo'] }}" class="h-20px app-sidebar-logo-minimize" />
        </a>
        <!--end::Logo image-->
    ...
    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ $current == 'dashboard' ? 'active' : '' }}"
                        href="{{ route('admin.dashboard') }}">
                    ...
                    <a class="menu-link" href="">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: /var/www/preview.keenthemes.com/kt-products/docs/metronic/html/releases/2022-08-18-143101/core/html/src/media/icons/duotune/general/gen007.svg-->
                    ...
                    <a class="menu-link" href="">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: /var/www/preview.keenthemes.com/kt-products/docs/metronic/html/releases/2022-08-18-143101/core/html/src/media/icons/duotune/finance/fin008.svg-->
                            <span class="svg-icon svg-icon-muted svg-icon-2"><svg width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.3"
                    ...
                    <a class="menu-link " href="">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: /var/www/preview.keenthemes.com/kt-products/docs/metronic/html/releases/2022-08-18-143101/core/html/src/media/icons/duotune/ecommerce/ecm003.svg-->
                    ...
                    <a class="menu-link" href="">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: /var/www/preview.keenthemes.com/kt-products/docs/metronic/html/releases/2022-08-18-143101/core/html/src/media/icons/duotune/coding/cod001.svg-->
    ...
    <div class="app-sidebar-footer flex-column-auto pt-2 pb-6 px-6" id="kt_app_sidebar_footer">
        <a href="{{ url('/') }}"
            ...
            title="you can visit home page from here">
            <span class="btn-label">Users Interface</span>
            <!--begin::Svg Icon | path: icons/duotune/general/gen005.svg-->
