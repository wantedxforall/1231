        ...
        .then((data) => {
            ...
            if (container) {
                numbers.forEach((number, index) => {
                    ...
                    let htmlContent = `
                        <div class="mx-auto" style="width: fit-content; margin-bottom: 10px;">
    ...
    fetch(
        ...
        .then((result) => {
            ...
            if (result.status === "success") {
                document.getElementById("senderName").value = null;
...
let senderNamefund = document.getElementById("senderName");
if (senderNamefund) {
    PaymentInfo();
}
