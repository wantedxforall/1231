@extends('front.layouts.app_blank', ['title' => '404 Not Found'])
<style>
    body,
    html {
        height: 100%;
...
@section('content')
    <!--begin::Root-->
    <div class="d-flex flex-column flex-root" style="background-image: url({{ asset('assets/media/auth/bg1.jpg') }}) ; background-size: cover;
